...
namespace UnityEditor
{
    public class LinkDemoWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            GUIExtension.LinkFileLabelField(new Rect(0,100,120,16), "EditorGUIExtension.cs","Assets/Editor/Examples/Example_34_LinkField/EditorGUIExtension.cs");
            GUIExtension.LinkUrlLabelField(new Rect(0,120,150,16),"UnityToolchainsTrick仓库","https://github.com/XINCGer/UnityToolchainsTrick");
        }
    }
}