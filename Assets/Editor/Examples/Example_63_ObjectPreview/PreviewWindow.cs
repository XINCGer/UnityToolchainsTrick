...
namespace CZToolKit.Examples
{
    public class ObjectPreviewWindow : EditorWindow
    {
        ...
        private void OnEnable()
        {
            ...
            foreach (var item in AssetDatabase.LoadAllAssetRepresentationsAtPath("Assets/Editor/Examples/Example_63_ObjectPreview/SF_Animal_Boar.fbx"))
            {
                switch (item)
                {
            ...
            Type animationClipEditorType = Assembly.Load("UnityEditor.CoreModule").GetType("UnityEditor.AnimationClipEditor");
            MethodInfo initMethod = animationClipEditorType.GetMethod("Init", BindingFlags.Instance | BindingFlags.NonPublic);
            initMethod.Invoke(animEditor, null);



            UnityEngine.Object texture = AssetDatabase.LoadAssetAtPath<UnityEngine.Object>("Assets/Editor/Examples/Example_63_ObjectPreview/Wallpaper 5.png");
            textureEditor = Editor.CreateEditor(texture);

            UnityEngine.Object audioClip = AssetDatabase.LoadAssetAtPath<UnityEngine.Object>("Assets/Editor/Examples/Example_63_ObjectPreview/Click.wav");
